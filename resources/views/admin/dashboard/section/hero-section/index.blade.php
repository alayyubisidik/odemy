                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="label" id="label" value="{{ old('label', $hero?->label) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $hero?->title) }}">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="subtitle" id="subtitle" value="{{ old('subtitle', $hero?->subtitle) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="button_text" id="button_text" value="{{ old('button_text', $hero?->button_text) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="button_url" id="button_url" value="{{ old('button_url', $hero?->button_url) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="video_button_text" id="video_button_text" value="{{ old('video_button_text', $hero?->video_button_text) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="video_button_url" id="video_button_url" value="{{ old('video_button_url', $hero?->video_button_url) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="banner_item_title" id="banner_item_title" value="{{ old('banner_item_title', $hero?->banner_item_title) }}">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="banner_item_subtitle" id="banner_item_subtitle" value="{{ old('banner_item_subtitle', $hero?->banner_item_subtitle) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="image-preview-box">
                                    ...
                                    <img id="image-preview-one" class="img-preview" alt="Logo Preview"
                                        ...
                                        style="width: 200px; border-radius: 5px; margin-top: 20px; display: none {{ $hero?->image ? 'display: none;' : '' }}" />
                                </div>
                            </div>
                        </div>
