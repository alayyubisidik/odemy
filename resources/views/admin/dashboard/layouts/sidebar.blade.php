    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3 sidebar-menu">
                ...
                <li class="nav-item {{ setActive(['admin.settings.*'], 'active') }}">
                ...
                <li
                    ...
                    <div
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ setActive(['admin.blog-categories.*']) }}"
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ setActive(['admin.blogs.*']) }}"
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ setActive(['admin.blogs-comment*']) }}"
                                    href="{{ route('admin.blogs-comment') }}">
                                    Blog Comment
                                </a>
                            </div>
                        </div>
