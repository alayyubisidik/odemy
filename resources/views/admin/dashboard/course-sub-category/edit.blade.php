...
@section('content')
    <div class="container-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{ route('admin.course-sub-categories.update', ['courseCategory' => $courseCategory, 'courseSubCategory' => $courseSubCategory]) }}"
                                ...
                                <div class="image-upload-wrapper">
                                    ...
                                    <div class="image-preview-container">
                                        <img id="image-preview-one"
                                            src="{{ $courseCategory->icon ? asset($courseCategory->icon) : asset('assets/images/img-placeholder.png') }}"
                                            alt="Preview">
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="slug" id="slug"
                                    value="{{ old('slug', $courseSubCategory->slug) }}">
                            ...
                            <div class="mb-2">
                                <label for="" class="form-check form-switch form-switch-3">
                                    <input type="checkbox" class="form-check-input" value="1" name="is_active"
                                        @checked($courseSubCategory->is_active)>
                            ...
                            <div class="mb-2">
                                <label for="" class="form-check form-switch form-switch-3">
                                    <input type="checkbox" class="form-check-input" value="1" name="is_trending"
                                        @checked($courseSubCategory->is_trending)>
