    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ $course->title }} > {{ $chapter->title }} > Lessons (Update)</h3>
                <div class="card-actions">
                    <a href="{{ route('admin.courses.lessons.index', [$course, $chapter]) }}" class="btn btn-primary">Back</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.courses.lessons.update', [$course, $chapter, $lesson]) }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-4">
                                ...
                                <select name="storage" id="storage" class="form-select">
                                    ...
                                    <option value="upload"
                                        {{ old('storage', $lesson->storage) == 'upload' ? 'selected' : '' }}>
                                        Upload
                                    </option>
                                    <option value="youtube"
                                        {{ old('storage', $lesson->storage) == 'youtube' ? 'selected' : '' }}>
                                        Youtube
                                    </option>
                                    <option value="vimeo"
                                        {{ old('storage', $lesson->storage) == 'vimeo' ? 'selected' : '' }}>
                                        Vimeo
                                    </option>
                                    <option value="external_link"
                                        {{ old('storage', $lesson->storage) == 'external_link' ? 'selected' : '' }}>
                                        External Link
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="mb-4">
                                ...
                                <div class="upload_source {{ old('storage', $lesson->storage) === 'upload' ? '' : 'd-none' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="file_path" class="form-control" type="text" name="file"
                                            value="{{ old('file', $lesson->storage === 'upload' ? $lesson->file_path : '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="external_source">
                                    ...
                                    <input type="text" class="form-control" name="url" id="path"
                                        value="{{ old('url', $lesson->storage !== 'upload' ? $lesson->file_path : '') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-4">
                                ...
                                <select name="file_type" id="file_type" class="form-select">
                                    <option value="">Please Select</option>
                                    <option value="video"
                                        {{ old('file_type', $lesson->file_type) == 'video' ? 'selected' : '' }}>
                                        Video
                                    </option>
                                    <option value="audio"
                                        {{ old('file_type', $lesson->file_type) == 'audio' ? 'selected' : '' }}>
                                        Audio
                                    </option>
                                    <option value="doc"
                                        {{ old('file_type', $lesson->file_type) == 'doc' ? 'selected' : '' }}>
                                        Doc
                                    </option>
                                    <option value="file"
                                        {{ old('file_type', $lesson->file_type) == 'file' ? 'selected' : '' }}>
                                        File
                                    </option>
                                    <option value="pdf"
                                        {{ old('file_type', $lesson->file_type) == 'pdf' ? 'selected' : '' }}>
                                        Pdf
                                    </option>
                                </select>
                            ...
                            <div class="mb-2">
                                <label for="" class="form-check form-switch form-switch-3">
                                    <input type="checkbox" class="form-check-input" value="1" name="downloadable"
                                        {{ old('downloadable', $lesson->downloadable) ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="editor">{{ old('description', $lesson->description) }}</textarea>
                            ...
                            <div class="mb-2">
                                <label for="" class="form-check form-switch form-switch-3">
                                    <input type="checkbox" class="form-check-input" value="1" name="is_active"
                                        @checked(old('is_active', $lesson->is_active))>
