                        ...
                        <div class="wsus__breadcrumb_text">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    ...
                                    Last updated {{ date('d/m/Y', strtotime($course->created_at)) }}
                                </li>
                                            ...
                                            <div class="wsus__courses_instructor_text">
                                                ...
                                                <ul class="link d-flex flex-wrap">
                                                    @if ($course->instructor->facebook)
                                                        <li>
                                                            <a href="{{ $course->instructor->facebook }}">
                                                    ...
                                                    @if ($course->instructor->linkedin)
                                                        <li>
                                                            <a href="{{ $course->instructor->linkedin }}">
                                                    ...
                                                    @if ($course->instructor->website)
                                                        <li>
                                                            <a href="{{ $course->instructor->website }}">
                                                                <i style="font-size: 20px" class="ti ti-world"></i>
                                                            </a>
                                                        </li>
                                                    @endif
                                                    ...
                                                    @if ($course->instructor->github)
                                                        <li>
                                                            <a href="{{ $course->instructor->github }}">
                                                                <i style="font-size: 20px" class="ti ti-brand-github"></i>
                                                            </a>
                                                        </li>
                                                    @endif
                                                ...
                                                <div class="" style="width: 100%;display: flex; justify-content: space-between;">
                                                    ...
                                                    <span>
                                                        @for ($i = 1; $i <= $review->rating; $i++)
                                                            <i class="fas fa-star" style="color: #FFA121"></i>
                                                        @endfor
                                                    </span>
                                                </div>
                                                <p>{{ $review->review }}</p>
                                        ...
                                        {{-- <form action="{{ route('review.store') }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12" style="margin-bottom: 20px">
                                                    <textarea rows="7" placeholder="Comments" name="review"></textarea>
                    ...
                    <div class="wsus__courses_sidebar">
                        <div class="wsus__courses_sidebar_video">
                            ...
                            @if ($course->demo_video_source !== null)
                                <a class="play_btn venobox vbox-item" data-autoplay="true" data-vbtype="video"
                                    ...
                                    <img src="{{ asset('assets/frontend/dist/images/play_icon_white.png') }}"
                                        alt="Play" class="img-fluid">
                                </a>
                            @endif
                        </div>
                        <h3 class="wsus__courses_sidebar_price text-warning">
                            @if ($course->price == 0)
                                FREE
                        ...
                        <div class="wsus__courses_sidebar_list_info">
                            <ul>
                                <li>
                                    <p>
                                        <span><img src="{{ asset('assets/frontend/dist/images/clock_icon_black.png') }}"
                                ...
                                <li>
                                    <p>
                                        <span><img src="{{ asset('assets/frontend/dist/images/user_icon_black_2.png') }}"
                                                alt="User" class="img-fluid"></span>
                                        Student Enrolled
                                    </p>
                                    47
                                ...
                                <li>
                                    <p>
                                        <span><img
                                                src="{{ asset('assets/frontend/dist/images/language_icon_black.png') }}"
